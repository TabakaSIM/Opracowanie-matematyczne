...
\begin{document}
	...
	\Zadanietwoxtwo{Znaleźć sumę, różnicę, iloczyn i iloraz liczb zepolonych}{$1+2i \quad -3+4i$}{$3-i \quad 1-2i$}{$\frac{1}{2}+i \quad \frac{1}{2}-i$}{$-1 \quad 1+i$}
	
	\Zadanietwoxtwo{Rozwiązać równania}{$x^2+1=0$}{$x^2+x+1=0$}{$x^2+2x+3=0$}{$x^2+(4-3i)x+1-5i=0$}
