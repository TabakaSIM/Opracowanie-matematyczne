...
\begin{document}
	...
	\ZadanieTextowe{Wyznacz kąt ostry pentagramu.}
	\Zadanie{Zrób sobie teraz kawusie :3}{Ale pamiętaj: 2 łyżki cukru i bez mleka}
	\counterreset{counter}
	\ZadanieABCD{Treść zadania}{Dalsza treść zadania}{Odp: tak}{Odp: nie}{Odp: może}{Odp: nie wiem}
	\ZadanieABCDEF{Treść zadania}{Dalsza treść zadania}{Odp: tak}{Odp: nie}{Odp: może}{Odp: nie wiem}{Odp: ta pierwsza}{Odp: ta ostatnia}
	\Zadanietwoxtwo{Tresc zadania}{$x=1$}{$x=2$}{$x=3$}{$x=4$}
	
% Perform the calculation 2 + 2
The result of 2 + 2 is  \pgfmathparse{2+2}\pgfmathprintnumber[assume math mode=true, int detect]{\pgfmathresult}.
