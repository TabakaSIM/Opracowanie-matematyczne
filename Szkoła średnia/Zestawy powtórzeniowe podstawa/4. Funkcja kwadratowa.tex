...
\begin{document}
	...
	najmniejsza.}
	\ZadanieTextowe{Dany jest trójkąta równoramienny $ABC$, którego supa długości podstawy $AB$ i wysokości poprowadzonej z wierzchołka $C$ wynosi 14cm. Oblicz długość podstawy $AB$, dla którego pole tego trójkąta jest największe.}
	\ZadanieTextowe{Pani Ania sprzedaje w swoim sklepie książki. Za Każdą książkę kupuje za 20 zł, a sprzedaje za 35 zł. W miesiącu Pani Ania sprzedaje 50 takich książek. Zakładając, że obniżenie
